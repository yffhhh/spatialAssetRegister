...
### Support Workflow
1. If users report map errors:
   - confirm coordinates exist and are valid
   - rerun QA check
2. If exports appear incomplete:
   - verify active filters
   - clear filters and retry export
3. For recurring issues:
   - capture sample record IDs
   - log issue with date/time and action taken
